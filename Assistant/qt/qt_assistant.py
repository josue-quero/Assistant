...
"""
Assistant controler, a graphic interface for
Asistant, based on PyQt
...
from qt.qt_elements import (AssistantWindow, DownloadDialog, DownloadItem,
                            AssistantSettings, DownloadDetails)

from Assistant import (AssistantModel, AssistantWarning as KW, DownloadState)
...
class DownloadController:
    ...
    def initUI(self):
        self.ui_item = DownloadItem(self.project_root,
                                    f"Download batch {self.model.batch}",
                                    self.model.threaded)
...
class AssistantController:
    """Controller for QtAssistant and AssistantModel"""
    downloads = []

    def __init__(self):
        self.app = QApplication(sys.argv)
        self.app.setApplicationName("QtAssistant")
    ...
    def initUI(self):
        self.main_window = AssistantWindow(self.project_root)
    ...
    def openSettings(self):
        self.settings = AssistantSettings(self.project_root,
